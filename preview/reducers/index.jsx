...
const RootReducer = handleActions(
  {
    [ACTION_TYPES.QUOTE_UPDATE]: (state, action) =>
      Object.assign({}, state, {
...
export const getQuote = createSelector(getState, state => state.quote);
export const getInvoice = createSelector(getState, state => state.invoice);
export const getPDFData = createSelector(getState, state => state.pdf_data);
