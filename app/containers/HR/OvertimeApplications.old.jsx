        ...
        <div style={{maxHeight: 'auto'}}>
          ...
          <div style={{paddingTop: '0px'}}>
            ...
            >  
              ...
              <div ref={(r)=>this.toggle_container = r} key='overtimeApplications_col_toggles' style={{boxShadow: '0px 10px 35px #343434', marginLeft: '-35px', position: 'fixed', top:  '130px'}}>
                ...
                <Part>
                  <Row>
                    ...
                    <Field className="col-lg-1 col-md-2 col-sm-3 col-xs-4">
                      <label className="itemLabel">Overtime&nbsp;ID</label>
                    ...
                    <Field className="col-lg-1 col-md-2 col-sm-3 col-xs-4">
                      <label className="itemLabel">Overtime&nbsp;No.</label>
                      <label className="switch">
                        <input
