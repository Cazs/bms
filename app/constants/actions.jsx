...
// SAFETY
// ===========================================================
export const SAFETY_EDIT = 'SAFETY_EDIT';
export const SAFETY_UPDATE = 'SAFETY_UPDATE';
export const SAFETY_SAVE = 'SAFETY_SAVE';
export const SAFETY_DELETE = 'SAFETY_DELETE';
export const SAFETY_GET_ALL = 'SAFETY_GET_ALL';
export const SAFETY_SET_STATUS = 'SAFETY_SET_STATUS';
export const SAFETY_CONFIGS_SAVE = 'SAFETY_CONFIGS_SAVE';
export const SAFETY_DUPLICATE = 'INVOICE_DUPLICATE';